...
## Project Structure
    ...
    ├── goal_setting_workbo_37497  # Django project configurations
...
1. Clone this repo and `cd goal_setting_workbo_37497`
...
2. Clone this repo and `cd goal_setting_workbo_37497`
